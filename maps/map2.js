      ...
      "dialogOptions": [
        ...
        },
        {
          ...
          "options": [
            ...
            {
              "id": "mole_cureda2",
              "text": "I need your help clearing some rocks on the beach.",
              "available": true,
              "chains": ["mole_beach_refuse"],
              "closes": ["mole_cured"]
            }
          ]
        },
        {
          "id": "mole_beach_refuse",
          "available": false,
          "text": "The Mole's eyes go wide. He takes a step back.\n'Thou speakest of the beach? The shore of Charon?\nThat ancient ferryman hath taken a disliking to me.\nHe says I disturb the peace of his water with my tunnelling.\nIf I set paw upon his shore, he will curse me\nTo an eternity of damp oars and foggy memory!\nI dare not go there, friend. I dare not.'",
          "options": [
            {
              "id": "mole_beach_refuse_plead",
              "text": "Please, I really need this.",
              "available": true,
              "chains": ["mole_beach_plead2"]
            }
          ]
        },
        {
          "id": "mole_beach_plead2",
          "available": false,
          "text": "The Mole shuffles his paws nervously.\n'Thou art persistent, I give thee that.\nYet... thou didst save my life with that antidote.\nI owe thee a debt that gnaws at my conscience.\nPerhaps... perhaps I could be quick about it.'",
          "options": [
            {
              "id": "mole_beach_plead2_accept",
              "text": "It'll be quick, I promise.",
              "available": true,
              "chains": ["mole_beach_accept"]
            }
          ]
        },
        {
          "id": "mole_beach_accept",
          "available": false,
          "text": "The Mole sighs deeply, then nods.\n'Very well. For thee, I shall brave the ferryman's shore.\nWait for me on the beach. I shall meet thee there.'\nHe grabs a small pickaxe and shuffles toward the tunnel exit.",
          "options": [
            {
              "id": "mole_beach_accept_go",
